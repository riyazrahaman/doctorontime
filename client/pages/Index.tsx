          ...
          <div className="flex-1 lg:max-w-lg">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-3/4 h-16 bg-white/30 backdrop-blur-md rounded-full shadow-xl flex items-center justify-center">
                <p className="font-jakarta font-bold text-medical-dark text-center text-lg">
                  Faster Appointments, Better Care.
                </p>
              </div>
            </div>
          </div>
    ...
    <div className="group p-8 rounded-3xl shadow-lg transition-all hover:scale-105 bg-white text-gray-900 hover:bg-medical-primary hover:text-white">
      <div className="text-center space-y-6">
        <div className="w-28 h-28 mx-auto rounded-3xl flex items-center justify-center bg-medical-secondary">
          <Icon className="w-12 h-12 text-medical-primary group-hover:text-medical-primary" />
        </div>
