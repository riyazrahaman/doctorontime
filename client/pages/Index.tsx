...
import { Search, MapPin, Heart, Pill, Syringe, Brain, Clipboard, Hand, Dna, Eye, Plus, ChevronLeft, ChevronRight, Facebook, Twitter, Instagram } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex items-center justify-between h-full">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#" className="text-medical-primary font-inter text-base font-medium hover:text-medical-dark transition-colors">Home</a>
            <a href="#" className="text-black font-inter text-base hover:text-medical-primary transition-colors">Specialties</a>
            <a href="#" className="text-black font-inter text-base hover:text-medical-primary transition-colors">Doctors</a>
            <a href="#" className="text-black font-inter text-base hover:text-medical-primary transition-colors">OPO</a>
            <a href="#" className="text-black font-inter text-base hover:text-medical-primary transition-colors">Login</a>
          </nav>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t">
          <div className="px-4 py-3 space-y-3">
            <a href="#" className="block text-medical-primary font-inter text-base font-medium">Home</a>
            <a href="#" className="block text-black font-inter text-base">Specialties</a>
            <a href="#" className="block text-black font-inter text-base">Doctors</a>
            <a href="#" className="block text-black font-inter text-base">OPO</a>
            <a href="#" className="block text-black font-inter text-base">Login</a>
          ...
          <div className="flex-1 lg:max-w-2xl">
            <div className="space-y-6">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-jakarta leading-tight">
                ...
                <span className="text-medical-primary">Medical Consultation!</span>
              </h1>
    ...
    <section className="py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 space-y-6">
            <div>
              <p className="text-medical-primary font-inter text-base font-semibold mb-4">Integrity</p>
              <h2 className="text-medical-dark font-jakarta text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
                Our Stellar Values
              </h2>
            </div>
    ...
    <div className="bg-white p-8 rounded-2xl shadow-lg space-y-8">
      ...
      <div className="text-medical-dark">
        <svg width="30" height="30" viewBox="0 0 31 30" fill="none">
          <path d="M13.3871 20.3832C13.3871 21.5795 12.9684 22.5813 12.131 23.3888C11.2936 24.1963 10.2469 24.6 8.99081 24.6C7.79455 24.6 6.77772 24.1365 5.94034 23.2094C5.10296 22.2823 4.68427 21.1159 4.68427 19.7103C4.68427 18.6935 4.90856 17.572 5.35716 16.3458C5.83567 15.1197 6.44875 13.8785 7.19641 12.6225C7.97398 11.3664 8.84127 10.1253 9.79828 8.89909C10.7852 7.64302 11.7721 6.47666 12.759 5.40002L13.9702 6.38694C12.6245 7.97199 11.503 9.57199 10.6058 11.1869C9.70856 12.8019 9.17025 14.3869 8.99081 15.9421C10.1871 16.0318 11.2188 16.4804 12.0861 17.2879C12.9534 18.0954 13.3871 19.1271 13.3871 20.3832ZM26.2618 20.3832C26.2618 21.5795 25.8431 22.5813 25.0058 23.3888C24.1684 24.1963 23.1216 24.6 21.8656 24.6C20.6693 24.6 19.6525 24.1365 18.8151 23.2094C17.9777 22.2823 17.559 21.1159 17.559 19.7103C17.559 18.6935 17.7833 17.572 18.2319 16.3458C18.7104 15.1197 19.3235 13.8785 20.0712 12.6225C20.8488 11.3664 21.716 10.1253 22.6731 8.89909C23.66 7.64302 24.6469 6.47666 25.6338 5.40002L26.8002 6.38694C25.4544 7.97199 24.3329 9.57199 23.4357 11.1869C22.5684 12.8019 22.045 14.3869 21.8656 15.9421C23.0618 16.0318 24.0936 16.4804 24.9609 17.2879C25.8282 18.0954 26.2618 19.1271 26.2618 20.3832Z" fill="currentColor"/>
        </svg>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        />
        <div>
          <p className="text-medical-text-secondary font-inter text-sm font-semibold">{name}</p>
...
const TestimonialsSection = () => {
  const testimonials = [
    {
      quote: "Amazing team and amazing treatment from the best doctor in the world",
      name: "Michael",
      role: "Patient"
    },
    {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-medical-text-light font-inter text-sm hover:text-white transition-colors">Home</a></li>
                <li><a href="#" className="text-medical-text-light font-inter text-sm hover:text-white transition-colors">Surgery</a></li>
                <li><a href="#" className="text-medical-text-light font-inter text-sm hover:text-white transition-colors">OPD</a></li>
                <li><a href="#" className="text-medical-text-light font-inter text-sm hover:text-white transition-colors">Speciality</a></li>
                <li><a href="#" className="text-medical-text-light font-inter text-sm hover:text-white transition-colors">Consultation</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-medical-text-light font-inter text-sm hover:text-white transition-colors">Who we are</a></li>
                <li><a href="#" className="text-medical-text-light font-inter text-sm hover:text-white transition-colors">Our Vision</a></li>
                <li><a href="#" className="text-medical-text-light font-inter text-sm hover:text-white transition-colors">Our Team</a></li>
                <li><a href="#" className="text-medical-text-light font-inter text-sm hover:text-white transition-colors">Terms & Conditions</a></li>
                <li><a href="#" className="text-medical-text-light font-inter text-sm hover:text-white transition-colors">FAQs</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li className="text-medical-text-light font-inter text-sm">+923041234567</li>
                <li className="text-medical-text-light font-inter text-sm">favorite@doctor.com</li>
